...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, SignallingClient.SignalingInterface {
    ...
    private void getIceServers() {
        ...
        try {
            data = ("yoelpro:73bd9284-c80e-11e9-913d-0242ac110003").getBytes("UTF-8");
        ...
        Utils.getInstance().getRetrofitInstance().getIceCandidates(authToken).enqueue(new Callback<TurnServerPojo>() {
            ...
            public void onResponse(@NonNull Call<TurnServerPojo> call, @NonNull Response<TurnServerPojo> response) {
                ...
                showToast("iceServer successfully fetched");
            ...
            public void onFailure(@NonNull Call<TurnServerPojo> call, @NonNull Throwable t) {
                t.printStackTrace();
                Log.e("getIceServers()", "error get http request");
            }
        });
    }
    ...
    public void start() {
        ...
        if (videoCapturerAndroid != null) {
            // Capture commented to prevent video transfer, audio only, havent found way to doo audio only call
...
//        }
    ...
    public void onJoinedRoom() {
        ...
        // No need to trigger when both party joined room`
//        if (gotUserMedia) {
//            SignallingClient.getInstance().emitMessage("got user media");
//        }
    }
